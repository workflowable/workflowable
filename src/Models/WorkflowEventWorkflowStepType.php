...
/**
 * Workflowable\Workflowable\Models\WorkflowEventWorkflowStepType
 *
 * @property int $id
 ...
 *
 * @method static \Workflowable\Workflowable\Database\Factories\WorkflowEventWorkflowStepTypeFactory factory($count = null, $state = [])

 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Workflowable\Workflow\Models\WorkflowAction> $workflowActions
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Workflow whereFriendlyName($value)
